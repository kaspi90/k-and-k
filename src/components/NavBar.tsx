...
function NavBar(props: any) {
  ...
  return (
    <div className=" bg-neutral-100 mb-12 dark:bg-gray-900 dark:text-white">
      <nav
        id="nav"
        className="lg:flex hidden lg:flex-row flex-col justify-between items-center min-h-24  max-w-[1280px] px-8 mx-auto lg:mb-8 sm:flex-wrap sm:justify-center sm:pb-4 sm:px-2 "
      >
        <div className="flex items-center ">
          ...
          <div className="flex sm:gap-4 md:gap-3 lg:hidden">
        ...
        <div className="lg:flex gap-5 content-center items-center hidden">
        ...
        <div
          className="cursor-pointer mx-auto lg:hidden my-2"
      ...
      <nav
        id="nav"
        className="lg:hidden flex  flex-col justify-between items-center min-h-24  max-w-[1280px] px-8   w-full"
      >
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-5">
            ...
            <div
              className="cursor-pointer  lg:hidden my-2"
              onClick={() => setOpen(!isOpen)}
            >
              <AiOutlineMenu size={25} />
            </div>
      ...
      <div className="flex flex-col lg:hidden gap-5 content-center items-center justify-center  bg-neutral-200">
