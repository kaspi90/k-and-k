...
const Reference = () => {
  ...
  return (
    <div className="dark:bg-gray-800 mb-20">
      <div id="references" className=" mx-auto pt-12 h-fit max-w-[1280px]">
        ...
        <div className="flex lg:flex-row flex-col justify-center lg:gap-20">
          <div className="rounded-lg m-4 lg:m-0 lg:w-3/12  p-4 bg-neutral-100 dark:bg-gray-700 hover:scale-[1.03] transition-all overflow-visible h-fit">
            <p className="p-2">
              ...
              {isExtended && (
                <>
                  ...
                  signifikanten Unterschied gemacht. Kurz gesagt, Heike ist eine
                  kompetente, zuverlässige und äußerst fähige Entwicklerin. Ich
                  kann sie uneingeschränkt empfehlen und bin überzeugt, dass sie
                  in jedem Team einen wertvollen Beitrag leisten wird".
                  <p className="pt-2">
                    <a
                      href="#"
                      className="underline"
          ...
          <div className=" lg:w-3/12 lg:m-0  flex flex-col lg:gap-6">
            <div className=" rounded-lg p-4 m-4 lg:m-0 bg-neutral-100 dark:bg-gray-700  hover:scale-[1.03] transition-all overflow-visible h-fit">
              <p className="p-2">
                "Erik hat sehr gute Kenntnisse in verschiedenen Webtechnologien
                und kann diese auch sehr produktiv umsetzen. Die Zusammenarbeit
                bei verschiedenen Projekten war jedes mal top!"
              </p>
              <div className="flex p-2 items-center">
                <img src={michael} className="w-[64px] h-[64px] rounded-full" />
                <div className="p-2">
            ...
            <div className="rounded-lg p-4 m-4 lg:m-0 bg-neutral-100  dark:bg-gray-700  hover:scale-[1.03] transition-all overflow-visible h-fit">
              <p className="p-2">
                ...
                notwendig ist, und als Basis funktioniert auch die zuverlässige
                Arbeit an langatmigen Projekten. Ich habe mit Erik nun schon
                einige Aufträge über mehrere Jahre durch und würde jederzeit
                zurückkommen, wenn es um kluge Websites geht."
              </p>
              <div className="flex p-2 items-center">
          ...
          <div className=" rounded-lg m-4 lg:m-0 lg:w-3/12 p-4 bg-neutral-100 hover:scale-[1.03] transition-all overflow-visible h-fit dark:bg-gray-700 ">
            <p className="p-2">
              ...
              (Next.js, Tailwind und i18n), dem Aufsetzen des Projekts sowie bei
              der Entwicklung tatkräftig unterstützt. Wir würden uns freuen,
              auch bei zukünftigen Projekten auf die Expertise von Erik
              zurückgreifen zu können."
            </p>
            <div className="flex p-2 items-center">
              <img src={sebastian} className="w-[64px] h-[64px] rounded-full" />
              <div className="p-2">
