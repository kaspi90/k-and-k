  ...
  return (
    <div id="projects" className="w-4/5 mx-auto pt-12">
          ...
          <div className="rounded-xl w-1/2 sm:w-4/5 ">
            ...
            <div className="justify-center flex ">
              <a
                ...
                className="mr-4 inline-flex items-center px-6 py-4 space-x-2 text-sm font-bold text-white uppercase bg-gray-700 rounded-lg hover:bg-gray-900"
              >
                <span>
                  <svg
        ...
        <div className="flex content-center justify-center  flex-wrap-reverse">
          ...
          undefined"
            ...
            <div className=" rounded-xl p-12 sm:basis-96 w-1/2 mx-auto">
              <img src={mangaAnime} className="rounded-xl"></img>
            </div>
          </div>
        </div>
      </Slide>
      <Slide direction="up" triggerOnce>
        <div className="flex  justify-center  flex-wrap w-full  ">
          <div className=" rounded-xl p-12 w-1/2 sm:basis-96 ">
            <img src={pokemon} className="rounded-xl shrink-0 shadow-sm"></img>
          </div>
          <div className="rounded-xl w-1/2 sm:w-4/5 ">
            <div className="mb-6">
              <h3 className="mb-7 justify-center flex text-2xl font-semibold text-center text-gray-900 font-header  ">
      ...
      <Slide direction="up" triggerOnce>
        <div className="flex content-center justify-center  flex-wrap-reverse">
          ...
          undefined"
            ...
            <div className=" rounded-xl p-12 sm:basis-96 w-1/2 mx-auto">
              <img src={boardgame} className="rounded-xl"></img>
            </div>
          </div>
        </div>
      </Slide>
